...
public class ShowQuickElementOutlineHandler extends SourceEditorOperationHandler {
	
	
	public ShowQuickElementOutlineHandler() {
		super(SourceEditorViewer.SHOW_ELEMENT_OUTLINE);
	}
