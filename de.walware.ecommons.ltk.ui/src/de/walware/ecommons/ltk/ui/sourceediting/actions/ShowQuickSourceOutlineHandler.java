...
public class ShowQuickSourceOutlineHandler extends SourceEditorOperationHandler {
	
	
	public ShowQuickSourceOutlineHandler() {
		super(SourceEditorViewer.SHOW_SOURCE_OUTLINE);
	}
