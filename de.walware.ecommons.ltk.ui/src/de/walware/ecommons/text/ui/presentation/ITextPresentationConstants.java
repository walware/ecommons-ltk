...
public interface ITextPresentationConstants {
	...
	public static final String ANNOTATIONS_COMMON_OCCURRENCES_TYPE = "de.walware.ecommons.text.editorAnnotations.CommonOccurrences"; //$NON-NLS-1$
	
	public static final String ANNOTATIONS_WRITE_OCCURRENCES_TYPE = "de.walware.ecommons.text.editorAnnotations.WriteOccurrences"; //$NON-NLS-1$
